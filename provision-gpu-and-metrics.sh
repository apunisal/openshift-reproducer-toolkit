...
echo "  6. Import Grafana Dashboard: Injects NVIDIA's official DCGM Exporter dashboard into the OpenShift console."
...
echo "4. Prometheus will scrape the metrics and send them to Grafana."
echo ""
